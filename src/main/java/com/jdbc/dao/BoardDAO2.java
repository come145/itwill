...
public class BoardDAO2 {
	...
	public void insertData(BoardDTO dto) {
		...
		sql.append("insert into board (num,name,pwd,email,subject,content,").append("ipAddr,hitCount,created) ")
	...
	public void updateData(BoardDTO dto) {
		...
		jdbcTemplate.update(sql.toString(), dto.getName(), dto.getPwd(), dto.getEmail(), dto.getSubject(),
